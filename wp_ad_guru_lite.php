...
add_action('admin_notices', 'adguru_admin_notice_about_deprecation');
function adguru_admin_notice_about_deprecation()
{

      echo '<div class="notice notice-error">';
      echo '<p>Plugin <strong>WP Ad Guru Lite</strong> is <span style="color:red">deprecated</span> now. Deactivate and delete "WP Ad Guru Lite" plugin. And install completely new plugin <a target="_blank" href="https://wordpress.org/plugins/wp-ad-guru/"><strong>WP AD GURU</strong></a>. Don\'t worry, you will not lose current ads data and settings. </p> ';
      echo "</div>";
